		    ...
		    items: [
			{
			  ...
			  items: [{
                              ...
                              value: config.record.calendar_id
                                ...
                                xtype: 'container',
                                labelWidth: '250',
                                fieldLabel: _('mxcalendars.label_allday'),
                                combineErrors: true,
                                msgTarget : 'side',
                                layout: 'hbox',
                                defaults: {
                                ...
                                items: [
                                    {fieldLabel: _('mxcalendars.label_isallday')
                                    ,name:'allday'
                                    ,id:'allday'
                                    ,xtype:'checkbox'
			    ...
			    items: [
				{
				    ...
				    width: 150,
                                    value: config.record.startdate_date
                                    ,listeners:{select:{fn:function(ths, value) {
				...
				},
				{
				    ...
				    value: config.record.startdate_time
                                    ,listeners:{change:{fn:function(tht, value) {
